...
const NavbarComponent = {
  ...
  render(containerId = 'navbar-root') {
    ...
    container.innerHTML = `
      ...
      <div style="background: #1E293B; color: #F8FAFC; padding: 0.25rem 1.5rem; font-size: 0.8rem; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.5rem;">
        <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
          ...
          <button type="button" style="background: transparent; border: 1px solid #64748B; color: #FFF; border-radius: 4px; padding: 0 8px; cursor: pointer; min-height: 28px;" onclick="window.NavbarComponent.changeFontSize(-0.1)" title="ลดขนาดตัวอักษร">A-</button>
          <button type="button" style="background: transparent; border: 1px solid #64748B; color: #FFF; border-radius: 4px; padding: 0 8px; cursor: pointer; min-height: 28px;" onclick="window.NavbarComponent.resetFontSize()" title="ขนาดปกติ">A</button>
          <button type="button" style="background: transparent; border: 1px solid #64748B; color: #FFF; border-radius: 4px; padding: 0 8px; cursor: pointer; min-height: 28px;" onclick="window.NavbarComponent.changeFontSize(0.15)" title="เพิ่มขนาดตัวอักษร">A+</button>
          <button type="button" style="background: transparent; border: 1px solid #64748B; color: #FFD700; border-radius: 4px; padding: 0 8px; cursor: pointer; min-height: 28px;" onclick="document.body.classList.toggle('high-contrast')" title="โหมดความต่างสีสูง">⚡ ความต่างสีสูง</button>
        </div>
        ...
        <div class="navbar-content">
          ...
          <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
            ${isAuthenticated ? `
              ...
              <!-- Logout Button -->
              <button type="button" class="btn btn-secondary btn-sm" onclick="window.authController.logout()" title="ออกจากระบบเพื่อสลับสิทธิ์" style="font-weight: 600; padding: 0.45rem 0.85rem;">
